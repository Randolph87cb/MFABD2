...
FIXTURE_DIR = ROOT / "tests" / "fixtures" / "pc_home_recognition"
...
class FixtureController(CustomController):
    ...
    def request_uuid(self) -> str:
        return "pc-home-recognition-fixture"
...
def main() -> int:
    ...
    for case in cases:
        ...
        checks = {
            ...
            "expected_ocr": "Rec_HomePage_GA_Ocr",
            "expected_home_icon": "Rec_HomePage_PC_HomeIcon_Tpl",
        }
